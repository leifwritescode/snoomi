...
const onAppUpgrade: TriggerOnEventHandler<TriggerEventType[AppUpgrade]> = async (_, context) => {
...
const AppUpgradeTrigger: AppUpgradeDefinition = {
  event: 'AppUpgrade',
  onEvent: onAppUpgrade
};

export default AppUpgradeTrigger;
